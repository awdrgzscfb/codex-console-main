...
const elements = {
    ...
    outlookImportAllowImapFallback: document.getElementById('outlook-import-allow-imap-fallback'),
...
async function handleOutlookImport() {
    ...
    try {
        const result = await api.post('/email-services/outlook/batch-import', {
            ...
            allow_imap_fallback: elements.outlookImportAllowImapFallback.checked
        });
...
async function editOutlookService(id) {
    try {
        ...
        document.getElementById('edit-outlook-allow-imap-fallback').checked = service.config?.allow_imap_fallback === true;
...
async function handleEditOutlook(e) {
    ...
    const updateData = {
        ...
        config: {
            ...
            allow_imap_fallback: formData.get('allow_imap_fallback') === 'on'
        }
    };
